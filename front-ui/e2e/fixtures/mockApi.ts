  ...
  history: [
    {
      ...
      user_name: 'Юрий Ерёменко',
      action: 'field_changed',
      field: 'status',
      source: 'ui',
      old_value: 'in_progress',
      new_value: 'pending',
      created_at: '2026-08-08T19:26:00Z',
    },
    {
      id: 2,
      ticket_id: 'ticket-1001',
      ...
      source: 'ui',
      old_value: '',
      new_value: '<p>Выключены.<br />История такова:<br />- обратились с необходимостью прогрузить все доки в ЧЗ. Но не пересчитали хэши.<br />из-за чего отвалился TLS к RMSy.</p>',
      created_at: '2026-08-08T19:25:00Z',
    },
    {
      id: 3,
      ticket_id: 'ticket-1001',
      user_name: 'Юрий Ерёменко',
      action: 'connection_copied',
      field: 'litemanager',
      source: 'ui',
      old_value: '',
      new_value: 'MH_79893',
      created_at: '2026-08-08T11:40:00Z',
    },
    {
      id: 4,
      ticket_id: 'ticket-1001',
      user_name: 'Евгений Тюлькин',
      action: 'field_changed',
      field: 'assignee',
      source: 'ui',
      old_value: 'Евгений Тюлькин',
      new_value: 'Юрий Ерёменко',
      created_at: '2026-08-08T08:29:00Z',
    },
  ],
  attachments: [],
};
